    ...
    <WidgetBox.Root className="min-h-[380px]" {...rest}>
      ...
      <div className='space-y-3 pt-4'>
        ...
        <NoteItem
          ...
          description='Follow-up appointment for blood pressure monitoring. Bring recent lab results.'
          date={new Date('08/02/2024')}
          badges={[
            { label: 'Today', color: 'red' },
            { label: 'Medical', color: 'sky' },
          ]}
        />
        ...
        <NoteItem
          title='Physical Therapy Schedule'
          description='Monday, Wednesday, Friday at 10 AM. Focus on mobility exercises and balance training.'
