    ...
    <Dropdown.Root>
      ...
      >
        <Avatar.Root size='40' color='blue'>
          <Avatar.Image 
            src={currentProfile?.primaryCareRecipient.avatar || '/images/avatar/illustration/james.png'} 
            alt='' 
          />
        </Avatar.Root>
        <div
        ...
        >
          <div className='flex-1 space-y-1'>
            <div className='flex items-center gap-0.5 text-label-sm'>
              {currentProfile?.primaryCareRecipient.name || 'Robert Wudlick'}
              <IconVerifiedFill className='size-5 text-verified-base' />
            </div>
            <div className='text-paragraph-xs text-text-sub-600'>
              {currentProfile?.primaryCareRecipient.email || 'rwudlick@gmail.com'}
            </div>
          </div>
