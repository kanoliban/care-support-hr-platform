...
function CaregiverScheduleView() {
  ...
  // Filter shifts to only show caregiver-related shifts
    ...
    <main className="flex-1 overflow-auto">
      <div className="p-8">
        <header className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-semibold">Caregiver Schedule</h1>
            <p className="text-gray-600">Manage caregiver shifts and availability</p>
          </div>
...
export default CaregiverScheduleView;