  ...
  return (
    <div className='flex w-full flex-col gap-6'>
      ...
      <div className='flex flex-col gap-2'>
        <h1 className='text-title-h3 text-text-strong-950'>Subscription Status</h1>
        <p className='text-paragraph-md text-text-sub-600'>
          View your current subscription details and manage your billing preferences
        </p>
      </div>
        ...
        <div className='space-y-4'>
          ...
          <div className='rounded-xl bg-bg-soft-100 p-4'>
            <div className='flex justify-between items-start mb-3'>
              <div>
                <h3 className='text-title-h4 font-medium text-text-strong-950'>CareGiver OS</h3>
                <p className='text-paragraph-sm text-text-sub-600'>Professional care management for caregivers</p>
              </div>
              <div className='text-right'>
                <span className='text-title-h3 text-text-strong-950'>$29</span>
                <p className='text-paragraph-sm text-text-sub-600'>per month</p>
              </div>
            </div>
      ...
      {/* Available Plans */}
      <div className='space-y-4'>
        <h2 className='text-title-h4 text-text-strong-950'>Available Plans</h2>
